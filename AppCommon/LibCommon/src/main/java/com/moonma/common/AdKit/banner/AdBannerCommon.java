    ...
    public void onReceiveAd(int w, int h) {
        ...
        sActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LibCommon.Main().UnitySendMessage("Scene", "AdBannerDidReceiveAd", str);
            }
        });
    ...
    public void onLoadAdFail() {
        ...
        sActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LibCommon.Main().UnitySendMessage("Scene", "AdBannerDidReceiveAdFail", str);
            }
        });
    }
    @Override
    public void onLoadAdClick() {
        sActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LibCommon.Main().UnitySendMessage("Scene", "AdBannerDidClick", str);
