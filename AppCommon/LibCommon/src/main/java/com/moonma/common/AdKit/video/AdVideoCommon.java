...
Log.d(TAG,"adVideoDidFail");
               LibCommon.Main().UnitySendMessage("Scene", "AdVideoDidFail", "fail");
            }
        });
    }
    ...
    public void adVideoDidStart() {
        ...
        sActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LibCommon.Main().UnitySendMessage("Scene", "AdVideoDidStart", "start");
            }
        });
    }
    ...
    public void adVideoDidFinish() {
        sActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                LibCommon.Main().UnitySendMessage("Scene", "AdVideoDidFinish", "finish");
            }
        });
